...
public class RSAEncrypt {
    ...
    public static String getPublicKeyBase64(PublicKey publicKey) {
        return base64Encode2String(publicKey.getEncoded());
    }
    ...
    public static String getPrivateKeyBase64(PrivateKey privateKey) {
        return base64Encode2String(privateKey.getEncoded());
    }
    ...
    public static String encryptByPublicKey(String data, String pubKey) {
        try {
            ...
            return base64Encode2String(encryptedData);
        } catch (Exception e) {
            handleException(e);
        }
        return null;
     ...
     */
    public static String decryptByPrivateKey(String data, String prvKey) throws Exception {

            String encryptBase64Data = data.replaceAll("\\\\n", "").replaceAll("\\\\r", "");
