...
public class GridRecyclerDecoration extends RecyclerView.ItemDecoration {
    ...
    public GridRecyclerDecoration(int space) {
        this.space = space;
    }

    public GridRecyclerDecoration(int space, int color) {
        this.space = space;
        this.color = color;
    ...
    public GridRecyclerDecoration(int space, int color, int type) {
        this.space = space;
        this.color = color;
        mPaint = new Paint(Paint.ANTI_ALIAS_FLAG);
        mPaint.setColor(color);
    ...
    public GridRecyclerDecoration(int space, Drawable mDivider) {
        this.space = space;
