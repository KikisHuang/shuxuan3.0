...
public class BaseWebSocket extends WebSocketClient {
    ...
    public void onMessage(String message) {
        ...
        if (isDebug)
            LogUtils.i("WebSocketClient", "onMessage() == " + message);
    ...
    public void send(String text) {
        ...
        if (isDebug)
            LogUtils.i("WebSocketClient", "send msg === " + text);
    }
    ...
    public void onClose(int code, String reason, boolean remote) {
        ...
        try {
            ...
            e.printStackTrace();
            LogUtils.i("WebSocketClient", " error === " + e);
        }
    }
    ...
    public void onError(Exception ex) {
        ...
        if (isDebug)
            LogUtils.e("WebSocketClient", "onError() === " + ex);
