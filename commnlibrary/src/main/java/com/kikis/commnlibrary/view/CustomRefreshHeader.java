...
public class CustomRefreshHeader extends LinearLayout implements RefreshHeader {
    ...
    public CustomRefreshHeader(Context context, @Nullable AttributeSet attrs, int defStyleAttr) {
        ...
        View view = View.inflate(context, R.layout.module_view_widget_custom_refresh_header, this);
    ...
    public void onStateChanged(RefreshLayout refreshLayout, RefreshState oldState, RefreshState newState) {
        switch (newState) {
            case PullDownToRefresh: //下拉刷新开始。正在下拉还没松手时调用
                ...
                mImage.setImageResource(R.drawable.snail_pull_image);
                break;
            case Refreshing: //正在刷新。只调用一次
                //状态切换为正在刷新状态时，设置图片资源为小人卖萌的动画并开始执行
                mImage.setImageResource(R.drawable.module_anim_pull_snail_refreshing);
