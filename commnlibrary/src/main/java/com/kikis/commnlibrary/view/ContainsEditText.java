...
public class ContainsEditText extends EditText implements TextView.OnEditorActionListener {
     ...
     * @param enter    回车监听
     */
    public void setContentListener(EdittextListener listener, boolean enter) {
        this.listener = listener;
        if (enter)
            setOnEditorActionListener(this);
    }

    public ContainsEditText(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.mContext = context;
        initEditText();
    }
    ...
    public ContainsEditText(Context context, AttributeSet attrs, int defStyleAttr) {
    ...
    private void initEditText() {
        addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                if (listener != null)
                    listener.onContentChange(String.valueOf(s));
...
//                            Toast.makeText(mContext, "不支持输入Emoji表情符号", Toast.LENGTH_SHORT).show();
                            ...
                            Log.i(TAG, "ContainsEmojiEditText === " + e);
                        }
                    }
